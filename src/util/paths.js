 ...
 *
 * The server is a fully self-contained deployable (copy `server/` alone to a
 * machine and it must work): every filesystem path resolves under `server/` or
...
/** Absolute path to the server/ root (server/src/util → up 2 = server/). */
